...
newman
  .run({
    ...
    environment: require("../environments/DonationOrder-STG.postman_environment.json"),
    reporters: ["htmlextra"],
    reporter: { htmlextra: { export: "../report/donationOrder-STG-Report-"+new Date().toISOString()+".html" } },
